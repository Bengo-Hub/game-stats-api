...
func (_q *TeamQuery) loadManagedBy(ctx context.Context, query *UserQuery, nodes []*Team, init func(*Team), assign func(*Team, *User)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(team.ManagedByTable)
		s.Join(joinT).On(s.C(user.FieldID), joinT.C(team.ManagedByPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(team.ManagedByPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(team.ManagedByPrimaryKey[0]))

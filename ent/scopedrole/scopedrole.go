...
const (
	// Label holds the string label denoting the scopedrole type in the database.
	Label = "scoped_role"
	...
	EdgeUser = "user"
	// Table holds the table name of the scopedrole in the database.
	Table = "scoped_roles"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "scoped_roles"
...
// Columns holds all SQL columns for scopedrole fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ScopedRole queries.
